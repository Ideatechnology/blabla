...
$num_columns	= 3;
$can_delete	= $this->auth->has_permission('Link.Plugin.Delete');
$can_edit		= $this->auth->has_permission('Link.Plugin.Edit');
...
if($has_records){
	...
	$stat=$list->deleted==0?"<span class='label label-success'>Publis</span>'":"<span class='label label-danger'>Unpublish</span>";
		...
		$tipe ="<span class='label label-danger'>".$list->tipe."</span>";
...
<?php endif;?>
<td><a href="<?php echo site_url(SITE_AREA.'/plugin/link/edit/'.$list->id);?>"><?php echo $list->title;?></a>
<br /><?php echo $stat;?> 
</td>
<td><?php echo character_limiter($list->link,10);?><br />
<?php echo $tipe;?>
</td>
<td><?php 
if($list->file):
echo img(array($path_file.$list->file,"style"=>'width:200px;'));
endif;
 ?></td>
</tr>
<?php 
