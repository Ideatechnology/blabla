	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-vertical"'); ?>
		<fieldset>
			...
			<div class="form-group <?php echo form_error('kategori_kategori') ? 'error' : ''; ?>">
				<?php echo form_label("Kategori". lang('bf_form_label_required'), 'kategori_kategori', array('class' => 'control-label') ); ?>
				<div class='controls'>
			...
			<div class="form-group <?php echo form_error('kategori_ket') ? 'error' : ''; ?>">
				<?php echo form_label("Keterangan ", 'kategori_ket', array('class' => 'control-label') ); ?>
				<div class='controls'>
				...
				<input type="hidden" name="kategori_type_kategori" value="arsip">

			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="Simpan"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/plugin/arsip/kategori',"Batal", 'class="btn btn-warning"'); ?>
