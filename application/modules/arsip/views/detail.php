...
<h1 class="judul"> Detail Download</h1>
...
<div class="btn-group">
 ...
 <a target="_blank" href="<?php echo "http://www.kemendagri.go.id/media/".$arsip->filepath;?>" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-download"></span> Download </a>
