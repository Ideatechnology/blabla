...
$tmp_module_path = ($tmp_bonfire_version_numeric >= 0.7) ? "./application/modules/slide/": "/bonfire/modules/slide/";
$tmp_module_path_upload = ($tmp_bonfire_version_numeric >= 0.7) ? "./application/modules/slide/": "/bonfire/modules/slide/";
