<h1 class="judul"><?php echo lang('bf_judul_agenda');?></h1><hr / style="border:solid 1px #FF3300">
				...
				success: function( data ) {
					...
					if(data.status){
						...
						$.each(data.data, function(index, value) {
						    if(i % 2 == 0){
								html = html+'<div class="info1"><h4>'+value.time+' - '+value.time_ends+' </h4><p>'+value.event+' <br /><a href="<?php echo site_url();?>/agenda/detail/'+value.id+'">Selengkapnya..</a></p></div>';
							}else{
								html = html+'<div class="info2"><h4>'+value.time+' - '+value.time_ends+' </h4><p>'+value.event+' <br /><a href="<?php echo site_url();?>/agenda/detail/'+value.id+'">Selengkapnya..</a></p></div>';
							} 
							i++;
						});
					}else{
