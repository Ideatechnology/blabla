...
if ( ! function_exists('country_select'))
{
	...
	function country_select($selected_iso='', $default_iso='US', $select_name='iso', $class='' )
	{
		...
		$output  = '<select required name="'. $select_name .'" id="' . $select_name . '" ' . $class . ' >';
		$output .= '<option value="">&nbsp;</option>' . PHP_EOL;
...
if ( ! function_exists('kota_select'))
{
	...
	function kota_select($selected_code='', $default_abbr='', $select_name='kota', $class='',$provinsi='11')
	{
 	...
 	// Get the states for the selected country
			...
			$output  = '<select required name="'. $select_name . '" id="' . $select_name . '" ' . $class . ' >' . PHP_EOL;
			$output .= '<option value="">--'.lang('us_pilih_kota').'--</option>' . PHP_EOL;
...
if ( ! function_exists('provinsi_select'))
{
	 ...
	 * @return string The full html for the select input.
	 */
	function provinsi_select($selected_code='', $default_abbr='', $select_name='kota', $class='')
	{
 	...
 	// Get the states for the selected country
			...
			$output  = '<select required name="'. $select_name . '" id="' . $select_name . '" ' . $class . ' >' . PHP_EOL;
			$output .= '<option value="">--'.lang('us_pilih_provinsi').'--</option>' . PHP_EOL;
			foreach ($states as $abbrev)
			{
